...
fdescribe('EmployeesShowcaseComponent', () => {
  ...
  describe('ngOnInit', () => {
    ...
    it('should set panelListOptions', fakeAsync(() => {
      ...
      updateEmploees(component, [showcaseMock[0], showcaseMock[1]]);
  ...
  fdescribe('ngOnChanges', () => {
    ...
    beforeEach(fakeAsync(() => {
      ...
      fixture.autoDetectChanges();
      updateEmploees(component, startAvatarOrder);
      tick(1200);
    }));
    ...
    fit('should shuffle avatars if avatarSize > medium and width cannot contain all', fakeAsync(() => {
  ...
  //   // >>>>>>>>
  //   it('should display 1 avatar + show-more-indicator', fakeAsync(() => {
  //     fixtureWidth(fixture, 50);
  //     updateEmploees(component, [
  //       showcaseMock[0],
  //       showcaseMock[1],
